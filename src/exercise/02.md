...
`React.createElement(elementType, elementProps, ...children)` - create new object, that can render in different environments

`ReactDOM.render(parentElement, reactElement)` - render created element in DOM aka `document.body.appendChild`
